...
<div class="col-md-12 col-xs-12" name="reporte_adwords">
    ...
    <div class="col-md-12 col-xs-12">
        <div id="areaTablas">
            <?php $tmpl=array ( 
                'table_open'=>'<table id="adwords-table" width="100%" class="table table-striped table-condensed  table-bordered"  oncontextmenu="return false"
...
<form name="frm_exportar" action="<?php echo base_url()."reportes/listar_google_adwords_formulario" ?>" target="new_target" method="POST">
...
<script src="<?php echo base_url('assents/js/reportes/google_adwords_formulario.js');?>"></script>
