                ...
                <ul id="inbox-tabs" class="inbox-tabs nav nav-tabs padding-16 tab-size-bigger tab-space-1">
                    <li class="active">
                        <a data-toggle="tab" href="#inbox" >
                            ...
                            <span class="bigger-110"><?php echo lang('bandeja_entrada'); ?></span>
                        </a>
                    </li>
                    <?php /*
                    <li>
					...
					*/ ?>
                    ...
                    <li>
                        <a data-toggle="tab" href="#eliminado" >
                            ...
                            <span class="bigger-110"><?php echo lang('eliminadas') ?></span>
                        </a>
                    </li>
                </ul>
                                ...
                                <div id="id-message-list-navbar" class="message-navbar clearfix">
                                                            ...
                                                            <div class="row filter_0" id="0" name="filtro_avanzado_usuario" style="border-style: none; padding: 0px;">
                                                                <div class="form-group col-md-12" >
                                                                    ...
                                                                    <select name="filtro_estado" class="select_chosen" style="width: 300px;">
                                                                        ...
                                                                        <option value="2"><?php echo lang('no_respondido'); ?></option>
                                                                ...
                                                                <div class="col-md-12" id="campo_1">
                                                                    <span><?php echo lang("fecha_de_consulta") ?>:</span><br>
                                                                </div>
                                                                <div class="form-group col-md-6" id="campo_1">
                                                                    <span><?php echo lang('fecha_desde'); ?></span>
                                                                    <div class="input-group">
                                                                        <input name="FechaDesdeConsulta" value="" class="date-picker" type="text" readyonly="true" style="margin-right: 0px; width: 96px;">
                                                                ...
                                                                <div class="form-group col-md-6" id="condicion_1">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input name="FechaHastaConsulta" value="" class="date-picker" type="text" readyonly="true" style="margin-right: 0px; width: 96px;">
                                                                <span class="input-group-addon" style="padding: 3px 6px;">
                                                                    <i class="icon-calendar bigger-110"></i>
                                                                </span>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12" id="campo_1">
                                                                    <span><?php echo lang("fecha_de_respuesta") ?>:</span><br>
                                                                </div>
                                                                <div class="form-group col-md-6" id="campo_1">
                                                                    <span><?php echo lang('fecha_desde'); ?></span>
                                                                    <div class="input-group">
                                    ...
                                    <div class="message-bar">
                                        <div class="message-infobar" id="id-message-infobar">
                                            <span class="blue bigger-150"><?php echo lang("mensajes"); ?></span>
                                    ...
                                    <div style="text-align: inherit !important;">
                                        <span>
                                        ...
                                        <span data-field="nombre" data-order="desc" class="order-by remitente">
                                            <span class="grey bigger-110"><?php echo lang('remitente'); ?></span>
                                        </span>
                                        <span class="asunto">
                                            <span class="grey bigger-110"><?php echo lang('asunto_comunicado'); ?></span>
                                        </span>
                                        <span data-field="fechahoraconsulta" data-order="desc" class="order-by fecha_consulta">
                                            <span class="grey bigger-110"><?php echo lang('fecha_de_consulta'); ?></span>
                                        </span>
                                        <span data-field="fechahora" data-order="desc" class="order-by fecha_respuesta">
                                            <span class="grey bigger-110"><?php echo lang('fecha_de_respuesta'); ?></span>
                                        </span>
