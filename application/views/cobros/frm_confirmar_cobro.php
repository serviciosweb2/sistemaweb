...
<script>
    var cod_cobro_confirmar = '<?php echo $cod_cobro; ?>';
    var lang_confirmar = '';
    ...
    $('.fancybox-wrap').ready(function() {
        ...
        $('button[name="enviar"]').on('click', function() {
            ...
            $.ajax({
                url: BASE_URL + 'cobros/confirmarCobro',
                type: 'POST',
                data: 'codigo=' + cod_cobro_confirmar,
                cache: false,
                dataType: 'json',
                success: function(respuesta) {
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="blue bigger"><?php echo lang("confirmar_cobro"); ?><small><i class="icon-double-angle-right"></i>  <?php echo $cod_cobro . ', ' . $alumno ?></small></h4>
    </div>
        ...
        <form  id="confirmacion">
            ...
            <div class="row">
                <div class="form-group col-xs-12">
                    <label for="exampleInputPassword1"><?php echo lang("esta_seguro_que_desea_confirmar_el_cobro"); ?></label>
