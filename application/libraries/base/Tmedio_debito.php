...
* @access   private
*/
class Tmedio_debito extends class_general{
    ...
    * @access protected
    */
    protected $nombreTabla = 'medio_debito';
    ...
    */
     ...
     * @return boolean
     */
    public function guardarMedio_debito(){
     ...
     * @return integer
     */
    public function getCodigoMedio_debito(){
     ...
     */
    public function setMedio_debito(array $arrCamposValores){
        $retorno = "";
    ...
    * @return array
    */
    static function camposMedio_debito(CI_DB_mysqli_driver $conexion){
        return parent::_campos($conexion, "medio_tarjetas_debito");
    }

    /**
    * Buscar registros en la tabla medio_tarjetas_debito
    *
    ...
    */
    static function listarMedio_debito(CI_DB_mysqli_driver $conexion, array $condiciones = null, array $limite = null, array $orden = null, array $grupo = null, $contar = false){
