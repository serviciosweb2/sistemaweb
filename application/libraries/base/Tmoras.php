...
* Class Tmoras
*
*Class  Tmoras maneja todos los aspectos de moras
*
* @package  SistemaIGA
* @subpackage Moras
...
* @access   private
*/
class Tmoras extends class_general{
    ...
    */
    static function camposMoras(CI_DB_mysqli_driver $conexion){
        return parent::_campos($conexion, "moras");
    }
    ...
    */
    static function listarMoras(CI_DB_mysqli_driver $conexion, array $condiciones = null, array $limite = null, array $orden = null, array $grupo = null, $contar = false){
        return parent::_listar($conexion, "moras", $condiciones, $limite, $orden, $grupo, $contar);
    }
}
?>