...
/**
* Class Tprestador_ginfes
*
*Class  Tprestador_ginfes maneja todos los aspectos de prestador_ginfes
*
* @package  SistemaIGA
* @subpackage Prestador_ginfes
* @author   Ivan berthillod <ivan.sys@gmail.com>
* @author   Aquiles Gonzalez <sistemas1@iga-la.net>
* @version  $Revision: 1.1 $
* @access   private
*/
class Tprestador_ginfes extends class_general{

    /**
    * codigo de prestador_ginfes
    * @var codigo int
    * @access protected
    */
    protected $codigo;
    ...
    /**
    * nombre_configuracion de prestador_ginfes
    ...
    */
    ...
    /**
    * cod_punto_venta de prestador_ginfes
    ...
    */
    ...
    /**
    * inscripcion_municipal de prestador_ginfes
    ...
    */
    ...
    /**
    * numero_serie de prestador_ginfes
    ...
    */
    ...
    /**
    * optante_simples_nacional de prestador_ginfes
    ...
    */
    ...
    /**
    * incentivador_cultural de prestador_ginfes
    ...
    */
    ...
    /**
    * regimen_especial_tibutario de prestador_ginfes
    ...
    */
    ...
    /**
    * valor_cofins de prestador_ginfes
    ...
    */
    ...
    /**
    * valor_inss de prestador_ginfes
    ...
    */
    ...
    /**
    * valor_csll de prestador_ginfes
    ...
    */
    ...
    /**
    * item_lista_servicio de prestador_ginfes
    ...
    */
    ...
    /**
    * codigo_tributacion_municipio de prestador_ginfes
    ...
    */
    ...
    /**
    * porcentaje_facturar de prestador_ginfes
    ...
    * @access protected
    */
    protected $nombreTabla = 'general.prestador_ginfes';

    /* CONSTRUCTOR */

    /**
     * Constructor de la Clase prestador_ginfes
     *
    ...
    */
    ...
    /* PUBLIC FUNCTIONS */
    /**
     * Guarda un objeto nuevo de la clase prestador_ginfes o actualiza uno ya existente en la base de datos
     *
     * @return boolean
     */
    public function guardarPrestador_ginfes(){
        return $this->_guardar();
    }

    /**
     * Retorna el codigo del objeto prestador_ginfes
     *
     * @return integer
     */
    public function getCodigoPrestador_ginfes(){
        return $this->_getCodigo();
    }

    /**
     * actualiza los campos de prestador_ginfes según los datos enviados en el array de parametro
     * 
     * @param array $arrCamposValores   un array cuyos indices son las propiedades de prestador_ginfes y los valores son los valores a actualizar
     */
    public function setPrestador_ginfes(array $arrCamposValores){
        $retorno = "";
        ...
        if ($retorno <> ""){
            die("falta el parametro ".$retorno." en setPrestador_ginfes");
        } else {
    ...
    /**
    * retorna los campos presentes en la tabla prestador_ginfes en formato array
    * 
    * @param CI_DB_mysqli_driver $connection   La conexion actual
    * @return array
    */
    static function camposPrestador_ginfes(CI_DB_mysqli_driver $conexion){
        return parent::_campos($conexion, "general.prestador_ginfes");
    }

    /**
    * Buscar registros en la tabla prestador_ginfes
    *
    ...
    * @return mixed    Retorna la lista de prestador_ginfes o la cantdad de registros segun el parametro contar
    */
    static function listarPrestador_ginfes(CI_DB_mysqli_driver $conexion, array $condiciones = null, array $limite = null, array $orden = null, array $grupo = null, $contar = false){
        return parent::_listar($conexion, "general.prestador_ginfes", $condiciones, $limite, $orden, $grupo, $contar);
    }
}
?>