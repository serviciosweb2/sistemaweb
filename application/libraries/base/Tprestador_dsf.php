...
/**
* Class Tprestador_dsf
*
*Class  Tprestador_dsf maneja todos los aspectos de prestador_dsf
*
* @package  SistemaIGA
* @subpackage Prestador_dsf
* @author   Ivan berthillod <ivan.sys@gmail.com>
* @author   Aquiles Gonzalez <sistemas1@iga-la.net>
* @version  $Revision: 1.1 $
* @access   private
*/
class Tprestador_dsf extends class_general{

    /**
    * codigo de prestador_dsf
    * @var codigo int
    * @access protected
    */
    protected $codigo;
    ...
    /**
    * nombre_configuracion de prestador_dsf
    ...
    */
    ...
    /**
    * cod_punto_venta de prestador_dsf
    ...
    */
    ...
    /**
    * codigo_servicio de prestador_dsf
    ...
    */
    ...
    /**
    * nombre_servicio de prestador_dsf
    ...
    */
    ...
    /**
    * inscripcion_municipal de prestador_dsf
    ...
    */
    ...
    /**
    * codigo_actividad de prestador_dsf
    ...
    */
    ...
    /**
    * alicuota_cofins de prestador_dsf
    ...
    */
    ...
    /**
    * alicuota_inss de prestador_dsf
    ...
    */
    ...
    /**
    * alicuota_csll de prestador_dsf
    ...
    */
    ...
    /**
    * porcentaje_facturar de prestador_dsf
    ...
    */
    ...
    /**
    * regimen_especial_tributario de prestador_dsf
    ...
    * @access protected
    */
    protected $nombreTabla = 'general.prestador_dsf';

    /* CONSTRUCTOR */

    /**
     * Constructor de la Clase prestador_dsf
     *
    ...
    */
    ...
    /* PUBLIC FUNCTIONS */
    /**
     * Guarda un objeto nuevo de la clase prestador_dsf o actualiza uno ya existente en la base de datos
     *
     * @return boolean
     */
    public function guardarPrestador_dsf(){
        return $this->_guardar();
    }

    /**
     * Retorna el codigo del objeto prestador_dsf
     *
     * @return integer
     */
    public function getCodigoPrestador_dsf(){
        return $this->_getCodigo();
    }

    /**
     * actualiza los campos de prestador_dsf según los datos enviados en el array de parametro
     * 
     * @param array $arrCamposValores   un array cuyos indices son las propiedades de prestador_dsf y los valores son los valores a actualizar
     */
    public function setPrestador_dsf(array $arrCamposValores){
        $retorno = "";
        ...
        if ($retorno <> ""){
            die("falta el parametro ".$retorno." en setPrestador_dsf");
        } else {
    ...
    /**
    * retorna los campos presentes en la tabla prestador_dsf en formato array
    * 
    * @param CI_DB_mysqli_driver $connection   La conexion actual
    * @return array
    */
    static function camposPrestador_dsf(CI_DB_mysqli_driver $conexion){
        return parent::_campos($conexion, "general.prestador_dsf");
    }

    /**
    * Buscar registros en la tabla prestador_dsf
    *
    ...
    * @return mixed    Retorna la lista de prestador_dsf o la cantdad de registros segun el parametro contar
    */
    static function listarPrestador_dsf(CI_DB_mysqli_driver $conexion, array $condiciones = null, array $limite = null, array $orden = null, array $grupo = null, $contar = false){
        return parent::_listar($conexion, "general.prestador_dsf", $condiciones, $limite, $orden, $grupo, $contar);
    }
}
?>