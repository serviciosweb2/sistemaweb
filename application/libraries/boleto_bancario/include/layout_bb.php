...
#instr_header {
	background: url('<?php echo base_url(); ?>assents/img/boleto_bancario/logo_empresa.png') no-repeat top left;
	padding-left: 160px;
	height: 30px;
}
...
<!--
 ...
 -->
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
		...
		<tr>
                    <td width=150>
                            <IMG SRC="<?php echo base_url(); ?>assents/img/boleto_bancario/logobb.jpg">
                        </td>
			<td width=50>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo base_url(); ?>assents/img/boleto_bancario/logobb.jpg"></td>
			<td width=50>
        <div class="field_cod_banco"><?php echo $dadosboleto["codigo_banco_com_dv"]?></div>
			</td>
			<td class="linha_digitavel"><?php echo $dadosboleto["linha_digitavel"]?></td>
