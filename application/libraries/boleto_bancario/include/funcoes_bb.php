...
//echo $dadosboleto["data_vencimento"];die();
...
/**Verifica se um n�mero de documento � um CPF ou CNPJ, com ou sem os caracteres separadores.
* @author Manoel Campos da Silva Filho
* @param string $num_documento N�mero do documento a ser verificado o tipo
* @return string Retorna "cpf" se o n�mero informado tiver
* o total de d�gitos de um CPF (11, sem contar os separadores). Retorna "cnpj" se o n�mero
* tiver o total de d�gitos de um CNPJ (14, sem contar os separadores). 
* Sen�o, retorna uma string vazia*/
...
//Guarda inicial
?><img src=<?php echo base_url(); ?>assents/img/boleto_bancario/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo base_url(); ?>assents/img/boleto_bancario/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo base_url(); ?>assents/img/boleto_bancario/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo base_url(); ?>assents/img/boleto_bancario/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?php echo base_url(); ?>assents/img/boleto_bancario/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?php echo base_url(); ?>assents/img/boleto_bancario/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?php echo base_url(); ?>assents/img/boleto_bancario/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?php echo base_url(); ?>assents/img/boleto_bancario/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo base_url(); ?>assents/img/boleto_bancario/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da fun��o
