$(document).ready(function() {
    ...
    // CAPTURA DEL EVENTO CLICK DERECHO:
         ...
         $('#areaTablas').on('mousedown','#crm_consultasweb tbody tr',function(e){
