$(document).ready(function() {
    ...
    // CAPTURA DEL EVENTO CLICK DERECHO:
         ...
         $('#areaTablas').on('mousedown','#sugerenciaBaja tbody tr',function(e){
             ...
             //FUNCION DESPLIEGA MENU:  
                  ...
                  function despliegaMenu(x,y,codigo){
                    ...
                    $('#desplegable').remove();
                    var contenido='<div id="desplegable" class="span2">';
                    contenido+='<div class="row-fluid"><div class="span2 offset1"><img src="../assents/img/mini_pencil.png"></div>';
                    contenido+='<div class="span6"><a id="'+codigo+'" accion="modificar" href="#">modificar</div>';
                    contenido+='<div class="row-fluid"><div class="span12"><a id="'+codigo+'" accion="presupuestar" href="#">presupuestar</a></div></div><div class="row-fluid"><div class="span12"><a id="'+codigo+'" accion="pasar a alumno" href="#">pasar a alumno</a></div></div></div></div>';
