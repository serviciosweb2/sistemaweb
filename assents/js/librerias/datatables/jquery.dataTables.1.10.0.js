...
var LANGDATATABLE={
        ...
        'es':{
			...
			"oAria": {
				...
				"sSortAscending": ": activar orden de columnas ascendente",
	
				
				"sSortDescending": ": activar orden de columnas descendente"
			},
			...
			"sLengthMenu": "Mostrando_MENU_ entradas",
	
	
			
			"sLoadingRecords": "Mostrando...",
      ...
      'pt':{
			...
			"oAria": {
				...
				"sSortAscending": ": ativar ordem de colunas ascendente",
	
				
				"sSortDescending": ": ativar ordem de colunas descendente"
			},
			...
			"sZeroRecords": "Nenhum resultado foi achado"
		},
...
//console.log('lang que sale de la tabla',LANGDATATABLE[BASE_IDIOMA]);
...
(/** @lends <global> */function( $ ){ 
	...
	function _fnFeatureHtmlProcessing ( settings )
	{
		...
		return $('<div/>', {
			...
			.html('<i class="icon-spin icon-spinner orange2 bigger-160"></i>'+ settings.oLanguage.sProcessing)
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			if ( oInit.oLanguage )
			{
                           //console.log('PASO POR ACA:',oInit.oLanguage);
...
//                                var idiomaDATABLE = BASE_IDIOMA_DATATABLE == '' ? oInit.oLanguage : BASE_IDIOMA_DATATABLE ;
	...
	//LANGDATATABLE
		 ...
		 */
		"oLanguage": LANGDATATABLE[BASE_IDIOMA],
