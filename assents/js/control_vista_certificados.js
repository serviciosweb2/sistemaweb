$(document).ready(function() {
    ...
    // CAPTURA DEL EVENTO CLICK DERECHO:
         ...
         $('#areaTablas').on('mousedown','#academicoCertificados tbody tr',function(e){
