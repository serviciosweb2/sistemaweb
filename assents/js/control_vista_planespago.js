$(document).ready(function() {
    ...
    // CAPTURA DEL EVENTO CLICK DERECHO:
         ...
         $('#areaTablas').on('mousedown','#administracionPlanesPago tbody tr',function(e){
